...
Files: macbook-16.glb [639.28KB] > /Users/chloele/apple-website-clone/apple-website-clone/public/models/macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookModel16(props) {
  ...
  useEffect(() => {
	scene.traverse((child) => {
		if(child.isMesh) {
			//Change color if part is NOT noChangeParts
